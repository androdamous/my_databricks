...
The 'ingestion_events' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/ingestion_events/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] ingestion_events_etl` to your workspace.
